...
save_path = './Files/results_attribution/COPD_%s' % (method_name)
...
Explainer = MLP_Explainer(binary_pred = True, model_path = model_path, batch_size = args.batch_size, baseline = baseline, dataset = dataset, m = m, method = method)
#######################
# Dataset Iterator
