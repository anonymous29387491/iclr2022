...
save_path = './Files/results_attribution/drug_%s' % (method_name)
make_dir(save_path)
...
from shapley_explainers import RF_Explainer_binary
...
train_set = drug(data_path = data_path, train = True)
# Initialize Explainer
method = 'shapleytaylor'
Explainer = RF_Explainer_binary(model_path = model_path, baseline = baseline, batch_size = args.batch_size, dataset = train_set, method = method, m = m)
