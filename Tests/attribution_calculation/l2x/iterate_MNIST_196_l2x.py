...
if args.k != 0:  # only train if k > 0
    ...
    torch.save(sp_list, './Tests/attribution_calculation/l2x/sp_mapping_MNIST_196.pt')
    '''
    sp_list = torch.load('./Tests/attribution_calculation/l2x/sp_mapping_MNIST_196.pt')
